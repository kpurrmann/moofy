 ...
 */
class Application_Model_ClientMapperTest extends Ibuildings_Test_PHPUnit_DatabaseTestCase_Abstract {
	...
	public function testSetEntry() {
		...
		$email = $this->_clientMapper->setEntry($data);
		$this->assertInstanceOf('Application_Model_Client', $email);
	...
	public function testGetDbTable(){
		$db = $this->_clientMapper->getDbTable();
		$this->assertNotEmpty($db);
		$this->assertInstanceOf('Application_Model_DbTable_Clients', $db);
	}
